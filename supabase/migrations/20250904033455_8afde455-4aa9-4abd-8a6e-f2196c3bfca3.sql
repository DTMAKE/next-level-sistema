-- Fix commission due date to match contract receivable due date
...
BEGIN
    ...
    WHILE current_month <= end_month LOOP
        ...
        IF admin_user_id IS NOT NULL THEN
            ...
            INTO contract_record.vendedor_nome, contract_record.vendedor_role, vendedor_percentual
            FROM public.profiles
            ...
            IF vendedor_percentual > 0 THEN
                ...
                IF NOT EXISTS (
                    ...
                    -- Create commission payable with SAME due date as receivable
                    INSERT INTO public.transacoes_financeiras (
                        user_id,
                        tipo,
                        data_transacao,
                        ...
                        due_date, -- FIXED: Use same due date as receivable, not end of month
