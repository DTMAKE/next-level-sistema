-- Add commission percentage for active contracts field to profiles table
ALTER TABLE public.profiles 
ADD COLUMN percentual_comissao_contrato numeric DEFAULT 1.00;

-- Add comment to explain the new field
COMMENT ON COLUMN public.profiles.percentual_comissao_contrato IS 'Commission percentage for active contracts (default 1%)';

-- Update existing trigger to use contract-specific commission for contracts
