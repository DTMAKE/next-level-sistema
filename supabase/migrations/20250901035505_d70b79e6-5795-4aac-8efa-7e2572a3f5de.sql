-- Fix the commission duplication issue
-- The trigger was creating one financial transaction per admin
-- Now it will create only one transaction linked to the first admin
